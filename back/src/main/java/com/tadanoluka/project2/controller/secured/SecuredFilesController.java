package com.tadanoluka.project2.controller.secured;
...
@RestController
@RequestMapping("api/v1/secured/files")
public class SecuredFilesController {

    private final StorageService storageService;
    private final FileService fileService;

    @Autowired
    public SecuredFilesController(StorageService storageService, FileService fileService) {
    ...
    public ResponseEntity<?> getAllFilesList() {
        List<FileDTO> files = fileService.getAllFilesList();
        if (files == null) {
